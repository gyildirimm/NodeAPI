...
const passwordToHashWithEmail = (password, email) => {
    return CryptoJS.HmacSHA256(password, CryptoJS.HmacSHA1((password + email), process.env.PASSWORD_HASH).toString()).toString();
}
